...
ARGUMENTS = [
    ...
    DeclareLaunchArgument('topic_whitelist',
        default_value=['["/camera/image_raw/compressed","/camera/camera_info","/cerebri/out/status","/cerebri/in/pixy_vector","/debugImage","/cerebri/out/nav_sat_fix","/robot_description","/tf"]'],
